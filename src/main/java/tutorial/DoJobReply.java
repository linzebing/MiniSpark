            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pairs = new java.util.ArrayList<StringNumPair>(_list27.size);
                StringNumPair _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new StringNumPair();
                  _elem28.read(iprot);
                  struct.pairs.add(_elem28);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DoJobReply struct) throws org.apache.thrift.TException {
      ...
      if (struct.lines != null) {
        oprot.writeFieldBegin(LINES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter30 : struct.lines)
          {
      ...
      if (struct.pairs != null) {
        oprot.writeFieldBegin(PAIRS_FIELD_DESC);
        {
          ...
          for (StringNumPair _iter31 : struct.pairs)
          {
            _iter31.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetLines()) {
        {
          ...
          for (java.lang.String _iter32 : struct.lines)
          {
      ...
      if (struct.isSetPairs()) {
        {
          ...
          for (StringNumPair _iter33 : struct.pairs)
          {
            _iter33.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.lines = new java.util.ArrayList<java.lang.String>(_list34.size);
          java.lang.String _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = iprot.readString();
            struct.lines.add(_elem35);
          }
        }
        struct.setLinesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.pairs = new java.util.ArrayList<StringNumPair>(_list37.size);
          StringNumPair _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new StringNumPair();
            _elem38.read(iprot);
            struct.pairs.add(_elem38);
          }
        }
        struct.setPairsIsSet(true);
      }
