...
public class DoJobReply implements org.apache.thrift.TBase<DoJobReply, DoJobReply._Fields>, java.io.Serializable, Cloneable, Comparable<DoJobReply> {
  ...
  private static final org.apache.thrift.protocol.TField REDUCE_RESULT_FIELD_DESC = new org.apache.thrift.protocol.TField("reduceResult", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  public int reduceResult; // required
  ...
  public DoJobReply setReduceResult(int reduceResult) {
    this.reduceResult = reduceResult;
    setReduceResultIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case REDUCE_RESULT:
      if (value == null) {
        ...
        setReduceResult((java.lang.Integer)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + reduceResult;
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pairs = new java.util.ArrayList<StringIntPair>(_list27.size);
                StringIntPair _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new StringIntPair();
                  _elem28.read(iprot);
          ...
          case 3: // REDUCE_RESULT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.reduceResult = iprot.readI32();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DoJobReply struct) throws org.apache.thrift.TException {
      ...
      if (struct.pairs != null) {
        oprot.writeFieldBegin(PAIRS_FIELD_DESC);
        {
          ...
          for (StringIntPair _iter31 : struct.pairs)
          {
            _iter31.write(oprot);
          }
          oprot.writeListEnd();
      ...
      oprot.writeI32(struct.reduceResult);
      oprot.writeFieldEnd();
      ...
      if (struct.isSetPairs()) {
        {
          ...
          for (StringIntPair _iter33 : struct.pairs)
          {
            _iter33.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.pairs = new java.util.ArrayList<StringIntPair>(_list37.size);
          StringIntPair _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new StringIntPair();
            _elem38.read(iprot);
