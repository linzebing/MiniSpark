              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<StringIntPair>(_list48.size);
                  StringIntPair _elem49;
                  for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                  {
                    _elem49 = new StringIntPair();
                    _elem49.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, readPartition_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (StringIntPair _iter51 : struct.success)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (StringIntPair _iter52 : struct.success)
            {
              _iter52.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<StringIntPair>(_list53.size);
            StringIntPair _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = new StringIntPair();
              _elem54.read(iprot);
